for i in *rmncRNA.bed;
   do coverageBed -a ../../annotation/AtRTDv2/constutive.5SS_50.bin.bed -b $i -s > ${i/bed/}5SS.count
      coverageBed -a ../../annotation/AtRTDv2/constutive.3SS_50.bin.bed -b $i -s > ${i/bed/}3SS.count
      a=`wc -l $i | cut -f 1 -d " " `
